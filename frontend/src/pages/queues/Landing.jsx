...
export default function Landing() {
    ...
    <div className="min-h-screen bg-[#05050a] text-white overflow-x-hidden">
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl text-center px-6">
          {/* <span className="inline-flex items-center gap-2 px-4 py-1.5 mb-8 rounded-full border border-purple-500/30 bg-purple-500/10 text-purple-300 text-sm">
  ...
  ">
    ...
    <div className="flex items-center justify-between mb-6">
      <h3 className="text-white font-medium text-lg">Warm Queue</h3>
    ...
    <div className="space-y-3 max-h-[280px] overflow-y-auto pr-1">
      ...
      <section className="max-w-6xl mx-auto px-6 py-28">
        ...
        <img src={landing_page_asset1} style={{height:500, width:425}}></img>
